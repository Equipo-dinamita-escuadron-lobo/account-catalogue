...
/**
 * @brief Controlador REST para gestión de cuentas bancarias
 *
 * Expone endpoints HTTP para operaciones CRUD de cuentas bancarias
...
public class BankAccountController {
    ...
    //("hasAuthority('Create_Bank_Account')")
    @PostMapping("/create")
    ...
    //("hasAuthority('Update_Bank_Account')")
    @PutMapping("/update")
    ...
    //("hasAuthority('Change_State_Bank_Account')")
    ...
    //("hasAuthority('Delete_Bank_Account')")
